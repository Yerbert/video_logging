...
public class PointCloudManager : MonoBehaviour {
	...
	// This is a coroutine so that the app doesn't freeze on 1 frame
	IEnumerator loadOFF(string dPath){
		...
		Debug.Log("  1. STARTED READING (" + numPoints + " points) ... ");
		...
		Debug.Log("  3. FINISHED INTANTIATING ... ");
